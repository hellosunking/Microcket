...
bin/krmdup: src/preprocess/krmdup.cpp
	@echo Build Krmdup
	@cd src/preprocess/; g++ krmdup.cpp -fopenmp -o ../../bin/krmdup $(GXXFlag) ; cd ../../

bin/krmdup.pipe: src/preprocess/krmdup.pipe.cpp
	@echo Build Krmdup
	@cd src/preprocess/; g++ krmdup.pipe.cpp -fopenmp -o ../../bin/krmdup.pipe $(GXXFlag) ; cd ../../
...
bin/sam2pairs: src/sam2pairs/pairutil.h src/sam2pairs/flash2pairs.h src/sam2pairs/unc2pairs.h src/sam2pairs/sam2pairs.cpp
	...
	@cd src/sam2pairs/; g++ sam2pairs.cpp -fopenmp -o ../../bin/sam2pairs $(GXXFlag) ; cd ../../
