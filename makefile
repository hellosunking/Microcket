...
GXXFlag=-march=native -std=c++11 -O2 -fopenmp
...
bin/ktrim.mod: src/preprocess/ktrim.cpp src/preprocess/common.h src/preprocess/util.h src/preprocess/param_handler.h src/preprocess/pe_handler.h
	@echo Build Ktrim
	@cd src/preprocess/; g++ -lz $(GXXFlag) -o ../../bin/ktrim.mod ktrim.cpp; cd ../../

bin/krmdup: src/preprocess/krmdup.cpp
	@echo Build Krmdup
	@cd src/preprocess/; g++ $(GXXFlag) -o ../../bin/krmdup krmdup.cpp; cd ../../

bin/cut.fq.tail: src/preprocess/cut.fq.tail.cpp
	@echo Build cut.fq.tail
	@cd src/preprocess/; g++ $(GXXFlag) -o ../../bin/cut.fq.tail cut.fq.tail.cpp; cd ../../
